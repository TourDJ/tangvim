...
## Vim Use Experience(使用心得)
  ...
  - [Config(配置)](./config.md)       
  - [Directive(指令)](./directive.md)       
  - [Command(命令)](./command.md)      
  - [Modeline（模式行）](./modeline.md)   
  - [Register(寄存器)](./register.md)
  - [Keyboard mapping(键盘映射)](./key-mapping.md)      
  - [Auto command(自动命令)](./autocmd.md)    
  - [Operator-Pending mapping(Operator-Pending 映射)](./operator-pending-mapping.md)      
  - [Abbreviations(缩写)](./abbreviations.md)        
  - [Plugin(插件)](./plugin.md)        
  - [Theme(主题)](./theme.md)    
